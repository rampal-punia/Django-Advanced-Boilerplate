...
class ImageSet(CreationModificationDateBase):
    ...
    def get_absolute_url(self):
        return reverse("dropzoneimages:imageset_detail_url", kwargs={"pk": self.pk})


class ImagesUpload(models.Model):
    image_set = models.ForeignKey('dropzoneimages.ImageSet',
                                  related_name="images",
                                  on_delete=models.CASCADE,
    ...
    def get_delete_url(self):
        return reverse("dropzoneimages:images_list_url", kwargs={"pk": self.image_set.id})
